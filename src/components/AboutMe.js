    ...
    <div className={classes.root}>
      ...
      >
        <Typography className={classes.main}>
          ...
          to draw, paint, play piano, and garden. I especially love
      ...
      >
        <Typography className={classes.main}>
          ...
          in! I also enjoy backend and full stack development. My strong suits are Java, JavaScript,
          and Python, but I have experience with other languages too! Machine learning is also
          an interest of mine, and I'm currently working on an undergraduate thesis about big data 
          anonymization.
        </Typography>
      </Fade>
    </div>
