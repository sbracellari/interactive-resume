    ...
    <div className={classes.root}>
      ...
      >
        <Typography className={classes.main}>
          Since May of 2018, I've been working as a student full stack developer at
          Oakland University's University Technology Services (UTS).
        </Typography>
      </Fade>
      <Fade 
        in={true} 
      ...
      >
        <Typography className={classes.main}>
          I've really loved my job at UTS, and I'd love to find another full stack development job that
          allows me to grow and learn just as my position at UTS has.
        </Typography>
      </Fade>
    </div>
    </div>
